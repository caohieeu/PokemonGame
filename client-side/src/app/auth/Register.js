    ...
    return (
        <div className="md:flex md:flex-row flex-col">
            <div className="w-full flex justify-center items-center">
                <div className="bg-[url('https://cdn.discordapp.com/attachments/1001719496777682985/1282630456021618688/thumb-1920-206263.png?ex=66e00e32&is=66debcb2&hm=3fae0477b25a06a5773b894f3b5fe7a8dc475a3be684e16b70cba9f11a46afdf&')] 
